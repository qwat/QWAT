...
/* Columns*/
ALTER TABLE distribution.pipes_material ADD COLUMN "short_name" VARCHAR(6);
...
ALTER TABLE distribution.pipes_material ADD COLUMN "_fancy_name" VARCHAR(16); /* created automatically, used for display only*/
/* Comment */
