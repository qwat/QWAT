...
CREATE VIEW distribution.installation_view AS 
	SELECT
		...
		installation_status.status   AS _status        ,
		installation_status.active   AS _status_active ,
	...
	INNER      JOIN distribution.installation_status ON installation.id_status  = installation_status.id 
