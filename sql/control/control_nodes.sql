...
SELECT a.id , b.id , ST_Distance(a.geometry,b.geometry)::decimal(6,4), 'cercle ' || ST_X(ST_AsText(a.geometry))::decimal(10,1)||','||ST_Y(ST_AsText(a.geometry))::decimal(10,1) AS autocad_cercle
