...
/usr/lib/postgresql/9.1/bin/pgsql2shp -h 172.24.171.202 -g geom -f pipes -P db4wat$ -u sige sige "
SELECT pipes_schema.id AS ID,
geometry AS geom,
_length2d AS LONGU_2D,
CASE WHEN _length3d_uptodate IS TRUE THEN _length3d ELSE NULL END AS LONGU_3D,
remarks AS REMARQUE,_precision AS PRECISIO,
_owner AS DISTRIBU,
...
NULL::boolean AS A_DESAFE FROM distribution.pipes_schema
"
