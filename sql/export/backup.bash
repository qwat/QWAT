...
then
	...
	psql -h 172.24.171.202 -U sige -c "SELECT 'UPDATE distribution.pipe SET id_parent='||id_parent||' WHERE id='||id||';' FROM distribution.pipe WHERE id_parent IS NOT NULL ORDER BY id_parent;" > temp
