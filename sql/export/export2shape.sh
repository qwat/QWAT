...
export sqliteoutput=/home/denis/Documents/cartoriviera/sige_qwat.sqlite
...
export sql="$sql remark                              "; if [ $outputformat = "2" ]; then export sql="$sql AS remarques ,";else export sql="$sql ,";fi
...
export sql="$sql _installmethod                     "; if [ $outputformat = "2" ]; then export sql="$sql AS mode_pose ,";else export sql="$sql ,";fi
...
export sql="$sql _schema_visible                        "; if [ $outputformat = "2" ]; then export sql="$sql AS schema_vis";fi
