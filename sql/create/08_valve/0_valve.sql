...
ALTER TABLE distribution.valve ADD CONSTRAINT valve_id_labelschema_visible FOREIGN KEY (id_labelschema_visible) REFERENCES distribution.vl_labelview(id)      MATCH FULL; CREATE INDEX fki_valve_id_labelschema_visible ON distribution.valve(id_labelschema_visible);
