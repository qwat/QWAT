...
ALTER TABLE distribution.wateringoutput ADD CONSTRAINT wateringoutput_id_status       FOREIGN KEY (id_status)       REFERENCES distribution.status(id)           MATCH FULL  ; CREATE INDEX fki_wateringoutput_id_status       ON distribution.wateringoutput(id_status)      ;
