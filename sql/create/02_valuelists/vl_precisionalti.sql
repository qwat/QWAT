...
CREATE TABLE distribution.vl_precisionalti (id integer not null, CONSTRAINT "precision_pk" PRIMARY KEY (id) );
...
INSERT INTO distribution.vl_precisionalti (id,code_sire,value_en,value_fr) VALUES (1122,0, 'Better than 50 cm' ,'Inférieure à 50 cm');     
INSERT INTO distribution.vl_precisionalti (id,code_sire,value_en,value_fr) VALUES (1122,0, 'Better than 10 cm' ,'Inférieure à 10 cm');     
INSERT INTO distribution.vl_precisionalti (id,code_sire,value_en,value_fr) VALUES (1122,0, 'Better than 5 cm'  ,'Inférieure à 5 cm');     
INSERT INTO distribution.vl_precisionalti (id,code_sire,value_en,value_fr) VALUES (1125,1, 'Unknown'           ,'Inconnue');   
