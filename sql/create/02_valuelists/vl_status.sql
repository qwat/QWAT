...
ALTER TABLE distribution.vl_status ADD COLUMN value_ro  varchar(30) default '';
...
ALTER TABLE distribution.vl_status ADD COLUMN helper_ro text default '';

/* VALUES */

INSERT INTO distribution.vl_status (id, value_en, value_fr, value_ro, active, sire, helper_en, helper_fr, helper_ro) VALUES (1307, '', 'fictif', 'Fictiv', true, 1, '', 'L''objet n''existe pas mais est nécessaire à l''intégrité topologique.', 'Obiectul este fictiv dar este necesar pentru integritatea topologică.');    /*  */
...
INSERT INTO distribution.vl_status (id, value_en, value_fr, value_ro, active, sire, helper_en, helper_fr, helper_ro) VALUES (1305, '', 'détruit', 'Distrus', false, NULL, '', 'L''objet a été partiellement ou complètement détruit.', 'Obiectul este distrus complet sau partial');    /*  */
...
INSERT INTO distribution.vl_status (id, value_en, value_fr, value_ro, active, sire, helper_en, helper_fr, helper_ro) VALUES (1301, '', 'en service', 'Functional', true, 1, '', 'Contribue actuellement au réseau.', 'Contribuie efectiv la reţea.');    /*  */
...
INSERT INTO distribution.vl_status (id, value_en, value_fr, value_ro, active, sire, helper_en, helper_fr, helper_ro) VALUES (1306, '', 'projet', 'Proiect', false, 0, '', 'L''objet est un projet validé en attente ou en cours de réalisation.', 'Obiectul face parte dintr-un proiect care se va face sau în curs de realizare. ');    /*  */
