...
INSERT INTO vl_status (id, value_en, value_fr, value_ro, active, sire, helper_en, helper_fr, helper_ro) VALUES (1301, '', 'en service', 'Functional', true, 1, '', 'Contribue actuellement au réseau.', 'Contribuie efectiv la reţea.');    /*  */
...
INSERT INTO vl_status (id, value_en, value_fr, value_ro, active, sire, helper_en, helper_fr, helper_ro) VALUES (1306, '', 'projet', 'Proiect', false, 0, '', 'L''objet est un projet validé en attente ou en cours de réalisation.', 'Obiectul face parte dintr-un proiect care se va face sau în curs de realizare. ');    /*  */
