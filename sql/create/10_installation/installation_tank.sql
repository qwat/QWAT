...
ALTER TABLE distribution.installation_tank ADD COLUMN view_schema        boolean                ;
...
ALTER TABLE distribution.installation_tank ADD COLUMN open_water_surface boolean default False  ;
ALTER TABLE distribution.installation_tank ADD COLUMN parcel             varchar(30)            ;
ALTER TABLE distribution.installation_tank ADD COLUMN eca                varchar(30)            ;
/* specific to tanks */
