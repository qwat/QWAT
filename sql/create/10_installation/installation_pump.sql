...
ALTER TABLE distribution.installation_pump ADD COLUMN id_status          smallint not null      ;
ALTER TABLE distribution.installation_pump ADD COLUMN id_distributor     smallint not null      ;
ALTER TABLE distribution.installation_pump ADD COLUMN id_remote          smallint               ;
ALTER TABLE distribution.installation_pump ADD COLUMN id_watertype       smallint not null      ;
ALTER TABLE distribution.installation_pump ADD COLUMN schema_visible        boolean NOT NULL default true ;
...
ALTER TABLE distribution.installation_pump ADD CONSTRAINT installation_pump_id_watertype    FOREIGN KEY (id_watertype)    REFERENCES distribution.vl_watertype(id) MATCH FULL;   CREATE INDEX fki_installation_pump_vl_watertype   ON distribution.installation_pump(id_watertype)   ;
ALTER TABLE distribution.installation_pump ADD CONSTRAINT installation_pump_id_type         FOREIGN KEY (id_type)         REFERENCES distribution.vl_pump_type(id) MATCH FULL;   CREATE INDEX fki_installation_pump_vl_pump_type   ON distribution.installation_pump(id_type)        ;
