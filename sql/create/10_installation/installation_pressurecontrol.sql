...
CREATE TABLE distribution.od_installation_pressurecontrol (id serial NOT NULL);
...
/* primary key */
ALTER TABLE distribution.od_installation_pressurecontrol ADD CONSTRAINT installation_pressurecontrol_pkey PRIMARY KEY (id);
