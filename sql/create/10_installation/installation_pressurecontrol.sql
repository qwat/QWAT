...
ALTER TABLE distribution.installation_pressurecontrol ADD COLUMN id_status          smallint not null      ;
ALTER TABLE distribution.installation_pressurecontrol ADD COLUMN id_distributor     smallint not null      ;
ALTER TABLE distribution.installation_pressurecontrol ADD COLUMN id_remote          smallint               ;
ALTER TABLE distribution.installation_pressurecontrol ADD COLUMN id_watertype       smallint not null      ;
ALTER TABLE distribution.installation_pressurecontrol ADD COLUMN schema_visible        boolean NOT NULL default true ;
