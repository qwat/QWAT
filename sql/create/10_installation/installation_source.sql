...
ALTER TABLE distribution.installation_source ADD COLUMN id_status          smallint not null      ;
ALTER TABLE distribution.installation_source ADD COLUMN id_distributor     smallint not null      ;
ALTER TABLE distribution.installation_source ADD COLUMN id_remote          smallint               ;
ALTER TABLE distribution.installation_source ADD COLUMN id_watertype       smallint not null      ;
ALTER TABLE distribution.installation_source ADD COLUMN schema_visible        boolean NOT NULL default true ;
...
ALTER TABLE distribution.installation_source ADD CONSTRAINT installation_source_id_type         FOREIGN KEY (id_type)         REFERENCES distribution.vl_source_type(id)    MATCH FULL;   CREATE INDEX fki_installation_source_vl_source_type    ON distribution.installation_source(id_type)        ;
ALTER TABLE distribution.installation_source ADD CONSTRAINT installation_source_id_watertype    FOREIGN KEY (id_watertype)    REFERENCES distribution.vl_watertype(id)      MATCH FULL;   CREATE INDEX fki_installation_source_vl_watertype      ON distribution.installation_source(id_watertype)   ;
ALTER TABLE distribution.installation_source ADD CONSTRAINT installation_source_id_quality      FOREIGN KEY (id_quality)      REFERENCES distribution.vl_source_quality(id) MATCH SIMPLE; CREATE INDEX fki_installation_source_vl_source_quality ON distribution.installation_source(id_quality)     ;
