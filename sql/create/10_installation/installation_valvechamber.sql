...
ALTER TABLE distribution.od_installation_valvechamber ADD COLUMN identification     varchar(25)            ;
...
SELECT distribution.fn_geom_tool_point('od_installation_valvechamber',true,    true,        true,             false,    true,          false);
