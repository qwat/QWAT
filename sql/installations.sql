...
ALTER TABLE distribution.installation ADD CONSTRAINT installation_id_status FOREIGN KEY (id_status) REFERENCES distribution.installation_status(id) MATCH FULL; CREATE INDEX fki_installation_id_status ON distribution.installation(id_status);
