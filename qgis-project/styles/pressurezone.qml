...
<qgis version="1.9.0-Master" minimumScale="0" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="colorcode" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category symbol="1" value="2" label="2"/>
      <category symbol="2" value="3" label="3"/>
      <category symbol="3" value="4" label="4"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="0.392157" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_unit" v="MM"/>
  ...
  <customproperties>
    ...
    <property key="itemBrowserSelection" value="[61L]"/>
  ...
  <edittypes>
    <edittype editable="1" type="0" name="colorcode"/>
    <edittype editable="1" type="0" name="consummerzone"/>
    <edittype editable="1" type="0" name="id"/>
    <edittype editable="0" type="0" name="id_parent"/>
    <edittype editable="1" type="0" name="name"/>
    <edittype editable="1" type="0" name="shortname"/>
  </edittypes>
  <editform>.</editform>
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].showHistory('pressurezone20130304110011384',[% $id %])" capture="0" type="1" name="History audit"/>
  </attributeactions>
</qgis>
