...
# PIPES
$ogr2ogrpath -sql "SELECT * FROM distribution.pipes_view" \
...
# PIPES SCHEMA
$ogr2ogrpath -sql "SELECT * FROM distribution.pipes_schema" \
 -overwrite -a_srs EPSG:21781 -f SQLite distribution.sqlite \
...
# NODES
$ogr2ogrpath -sql "SELECT * FROM distribution.nodes" \
 -overwrite -a_srs EPSG:21781 -f SQLite distribution.sqlite \
